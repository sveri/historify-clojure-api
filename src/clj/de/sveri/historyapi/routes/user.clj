(ns de.sveri.historyapi.routes.user
  (:require [compojure.core :refer [routes GET POST]]
            ...
            [de.sveri.historyapi.db.user :as db]
            [de.sveri.historyapi.service.user :as uservice]
            [de.sveri.historyapi.service.auth :as auth]
