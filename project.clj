(defproject historyapi "0.1.0-SNAPSHOT"
  ...
  {:builds {:dev {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                  :figwheel {:css-dirs ["resources/public/css"]             ;; watch and update CSS
                             :on-jsload "historyapi.dev/main"}
                  :compiler     {:main           "historyapi.dev"
  ...
  :profiles {:dev     {:repl-options {:init-ns          de.sveri.historyapi.user}
  ...
  :main de.sveri.historyapi.core

  :uberjar-name "historyapi.jar"
